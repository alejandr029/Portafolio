import Icons_About from "../assets/icons_about/icons";

export default function About() {
    return(
        <div className=" mx-auto w-[60%] text-left mt-[20vh]">
            <h3 className="text-3xl font-bold pt-20" >Hi I'm Alejandro</h3>
            <h2 className="text-2xl font-semibold animate-background-shine ">Software Developer</h2>
            <h2 className=" font-semibold inline-flex animate-background-shine bg-[linear-gradient(110deg,#64748b,45%,#0f172a,55%,#64748b)] dark:bg-[linear-gradient(110deg,#b6eaff,45%,#065074,55%,#b6eaff)] bg-[length:250%_100%] bg-clip-text text-xl text-transparent">examples</h2>
            ...
            <section className="information text-lg pt-10 ">
                ...
                <p>
                I enjoy design a website from scratch or generated a new version.
                </p>

                <p>
                I dont use only framworks technologies, I use other functions to generate a few things
                </p>
            </section>

            <ul className="grid grid-cols-4 grid-flow-row  ">
                <li className="w-auto">
                <Icons_About Name="Linkedin">
